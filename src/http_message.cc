...
std::string
to_string (HttpStatusCode status_code)
{
  switch (status_code)
    {
...
HttpMethod
string_to_method (const std::string &method_string)
{
...
HttpVersion
string_to_version (const std::string &version_string)
{
...
std::string
to_string (const HttpRequest &request)
{
...
std::string
to_string (const HttpResponse &response, bool send_content)
{
  std::ostringstream oss;
...
HttpRequest
string_to_request (const std::string &request_string)
{
...
HttpResponse
string_to_response (const std::string &response_string)
{
